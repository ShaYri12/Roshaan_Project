...
const EmissionPage = () => {
  ...
  const geocode = async (location) => {
    ...
    if (data && data[0]) {
      emissionRecordRecord((prev) => ({
        ...
        distance: data[0]?.distance || 0, // Update only the distance property
      }));
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      ...
      // setEmissionRecords((prevRecords) =>
    ...
    <div>
      ...
      <div className="container py-5">
        <div className="d-flex justify-content-between align-items-center mb-3">
          <p>Total Records: {emissionRecords.length}</p>
                    ...
                    <td>
                      <div className="d-flex">
                        ...
                        <button
                          ...
                          onClick={() => confirmDelete(record._id)} // This triggers confirmDelete
                        >
                          Delete
                        </button>
                      </div>
